...
def mfcc_filter_banks(sampling_rate, num_fft, lowfreq=133.33, linc=200 / 3,
                      logsc=1.0711703, num_lin_filt=13, num_log_filt=5):
    """
...
#     # features, feature_names = feature_extraction(signal=audioData, sampling_rate=Config.sample_rate,
...
#     acoustic_feature = None
#
#     # Feature extraction for Spectrogram
#     # 归一化
#     sig_array_norm = dc_normalize(audioData)
#
#     # spectrogram
...
#
#     # spectrogram_feature = (spectrogram_feature - spectrogram_feature.mean()) / (spectrogram_feature.std())
#
#     return acoustic_feature, spectrogram_feature
